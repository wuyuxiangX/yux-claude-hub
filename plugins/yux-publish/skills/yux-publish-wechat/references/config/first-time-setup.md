...
description: First-time setup flow for yux-publish-wechat preferences
---
...
options:
  - label: "Project (Recommended)"
    description: ".yux-publish/ (this project only)"
  - label: "User"
    description: "~/.yux-publish/ (all projects)"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.yux-publish/yux-publish-wechat/EXTEND.md` | Current project |
| User | `~/.yux-publish/yux-publish-wechat/EXTEND.md` | All projects |
